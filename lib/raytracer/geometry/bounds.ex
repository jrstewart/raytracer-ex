defmodule Raytracer.Geometry.Bounds do
  ...
  def expand(%Bounds{min_point: {_, _}, max_point: {_, _}} = bounds, delta) do
    v = {delta, delta}
    %Bounds{
      min_point: Point.subtract(bounds.min_point, v),
  ...
  def inside?(
    %Bounds{min_point: {min_x, min_y}, max_point: {max_x, max_y}},
    {x, y}
  ) do
  ...
  def inside?(
    %Bounds{min_point: {min_x, min_y, min_z}, max_point: {max_x, max_y, max_z}},
    {x, y, z}
  ) do
  ...
  def intersect(
    %Bounds{min_point: {min_x1, min_y1}, max_point: {max_x1, max_y1}},
    %Bounds{min_point: {min_x2, min_y2}, max_point: {max_x2, max_y2}}
  ) do
    %Bounds{
      min_point: {max(min_x1, min_x2), max(min_y1, min_y2)},
      max_point: {min(max_x1, max_x2), min(max_y1, max_y2)},
    }
  end

  def intersect(
    %Bounds{min_point: {min_x1, min_y1, min_z1}, max_point: {max_x1, max_y1, max_z1}},
    %Bounds{min_point: {min_x2, min_y2, min_z2}, max_point: {max_x2, max_y2, max_z2}}
  ) do
    %Bounds{
      min_point: {max(min_x1, min_x2), max(min_y1, min_y2), max(min_z1, min_z2)},
  ...
  def union(
    ...
    %Bounds{
      min_point: {min(min_x1, min_x2), min(min_y1, min_y2)},
  ...
  def union(
    ...
    %Bounds{
      min_point: {min(min_x1, min_x2), min(min_y1, min_y2), min(min_z1, min_z2)},
  ...
  def union(
    ...
    %Bounds{
      min_point: {min(min_x, x), min(min_y, y), min(min_z, z)},
